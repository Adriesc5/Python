#Juego de ahorcado, donde se adivina una palabra:Nombre de ciudad en Mexico
import random

from paquete_Sesion5 import palabras,monitos

def getRandomWord(wordList):
    # Esta función devuelve una palabra aleatoria de la lista de palabras.palabras pasada.
...
def displayBoard(missedLetters, correctLetters, secretWord):
    print(monitos[len(missedLetters)])
    print()
...
missedLetters = ''
correctLetters = ''
secretWord = getRandomWord(palabras)
gameIsDone = False
...
while True:
    ...
    if guess in secretWord:
        ...
        if len(missedLetters) == len(monitos) - 1:
            displayBoard(missedLetters, correctLetters, secretWord)
